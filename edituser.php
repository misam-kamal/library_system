        ...
        <div class="row vh-100">
            ...
            <div class="col-sm-10 ">
                <div class="text-center">
                    <h1 class="text-center mt-5 my-5" style="font-size:40px;font-family: 'Bowlby One SC', cursive;font-family: 'Cinzel Decorative', cursive;">Edite/Delete The User</h1>


                   
<div class="d-flex justify-content-center pt-5">
                    <table class="table w-50 " id="editable_table">
                        <thead>
                          <tr>
                            <td>User Id</td>
                            <td>User Name</td>
...
$(document).ready(function(){  
     $('#editable_table').Tabledit({
      ...
      columns:{
       ...
       editable:[[1, 'user_name'], [2, 'user_email'], [3, 'user_password'], [4, 'user_address']]
      },
      restoreButton:false,
